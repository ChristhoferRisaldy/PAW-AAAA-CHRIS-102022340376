...
*    - URL Prefix: `/admin`
*    - Routes related to article CRUD operations:
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    Route::get('/article', [ArticleController::class, 'index'])->name('admin.index');
    Route::get('/article/create', [ArticleController::class, 'create'])->name('admin.create');
    Route::post('/article', [ArticleController::class, 'store'])->name('admin.store');
    Route::get('/article/{article}/edit', [ArticleController::class, 'edit'])->name('admin.edit');
    Route::put('/articles{article}', [ArticleController::class, 'update'])->name('admin.update');
    Route::delete('/article/{article}', [ArticleController::class, 'destroy'])->name('admin.destroy');
});